...
# NoxLiquid Contributor License Agreement (CLA)

## 1. Введение
Этот документ юридически оформляет передачу прав на ваш код организации.

## 2. Определения
- **Контрибьютер** — лицо, вносящее изменения, коммиты, Pull Request или другой код в репозиторий.
- **Проект** — репозиторий организации NoxLiquid, включая весь его код, кроме MIT-наследия.
- **Организация / Основатель** — владелец репозитория, который управляет проектом.

## 3. Права контрибьютера
- Контрибьютер сохраняет авторские права на свой вклад.
- Контрибьютер может использовать свой код в других проектах и целях.

## 4. Права организации
- При предоставлении Contribution контрибьютер даёт организации **неисключительные, бессрочные, безвозмездные права**:
  - использовать код;
  - изменять код;
  - распространять код;
...
## 5. Подтверждения
Контрибьютер гарантирует:
- вклад является его собственным кодом;
- код не нарушает чужие авторские права или лицензии;
- вклад не содержит запрещённого контента.

## 6. Принятие
- Размещение Pull Request, Issue или коммита автоматически означает согласие с условиями CLA.
- CLA может быть изменён организацией, но изменения не затрагивают уже внесённые Contributions без согласия контрибьютера.
